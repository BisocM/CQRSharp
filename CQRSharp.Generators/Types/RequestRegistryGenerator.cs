...
namespace CQRSharp.Generators.Types
{
    ...
    public sealed class RequestRegistryGenerator : IIncrementalGenerator
    {
            ...
            ImmutableArray<INamedTypeSymbol?> candidateClasses)
        {
            ...
            sb.AppendLine("    /// A generated registrar that collects request metadata and populates a shared IRequestRegistry implementation.");
            sb.AppendLine("    /// </summary>");
            ...
            sb.AppendLine();
            sb.AppendLine("    /// <summary>");
            sb.AppendLine("    /// A module initializer that assigns the generated request registry registrar to the global Registrar.");
            sb.AppendLine("    /// </summary>");
            ...
            sb.AppendLine("            {");
            sb.AppendLine("                throw new InvalidOperationException(\"Failed to initialize GeneratedRequestRegistryRegistrar.\", ex);");
            sb.AppendLine("            }");
            sb.AppendLine("        }");
            sb.AppendLine("    }");
            sb.AppendLine("}");
