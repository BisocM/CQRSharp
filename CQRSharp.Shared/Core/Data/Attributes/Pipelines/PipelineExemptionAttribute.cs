namespace CQRSharp.Shared.Core.Data.Attributes.Pipelines;
...
public sealed class PipelineExemptionAttribute(Type exemptedPipeline) : Attribute
{
    ...
    ///     It is primarily used by the dispatcher to determine which pipeline behaviors should be excluded during command or
    ///     request processing.
    /// </remarks>
