...
/// <summary>
///     Rejects a <see cref="CqrsStartupValidationOptions" /> whose policy is not defined, at host start: it would otherwise
///     validate and never abort, acting as <see cref="CqrsValidationPolicy.WarnOnly" />.
/// </summary>
