...
///     <see cref="CQRSharp.RunMode.Queued" /> dispatch waits on it (bounded by
///     <see cref="CQRSharp.BackgroundTaskQueueOptions.ConsumerStartTimeout" />) before handing work over,
