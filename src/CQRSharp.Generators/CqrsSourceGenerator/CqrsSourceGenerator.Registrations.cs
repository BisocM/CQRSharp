...
public sealed partial class CqrsSourceGenerator
{
        ...
        GeneratorConfig config)
    {
        ...
        sb.AppendLine("        private static readonly Dictionary<Type, Delegate> __handlerInvokers = __BuildHandlerInvokers();");
        ...
        sb.AppendLine("        /// <inheritdoc />");
        sb.AppendLine("        public IReadOnlyDictionary<Type, Delegate> HandlerInvokers => __handlerInvokers;");
        sb.AppendLine("        /// <inheritdoc />");
        ...
        sb.AppendLine("        }");
        sb.AppendLine();
        sb.AppendLine("        private static Dictionary<Type, Delegate> __BuildHandlerInvokers()");
        sb.AppendLine("        {");
        GenerateHandlerRegistry(sb, handlerBindingsByRequest, known);
