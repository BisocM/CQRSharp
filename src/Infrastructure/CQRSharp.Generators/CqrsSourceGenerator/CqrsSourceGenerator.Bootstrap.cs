...
{
    private static string GenerateBootstrap(Compilation compilation)
    {
        ...
        if (compilation.GetTypeByMetadataName("CQRSharp.Pipelines.Extensions.ICqrsBuilder") is not null)
        {
            sb.AppendLine();
            sb.AppendLine(
