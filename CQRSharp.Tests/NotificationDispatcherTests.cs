...
// A simple notification for testing purposes
...
public class NotificationDispatcherTests
{
    ...
    public async Task Publish_WhenOutboxIsDisabled_DispatchesDirectly()
    {
        ...
        // Assert
        _mockDirectDispatcher.Verify(d => d.Publish(_testNotification, default), Times.Once);
    ...
    public async Task Publish_WhenOutboxIsEnabled_AddsToOutbox()
    {
        ...
        _mockDirectDispatcher.Verify(d => d.Publish(It.IsAny<INotification>(), default), Times.Never);
    }
    ...
    public void Publish_WhenOutboxEnabled_But_IOutboxNotRegistered_ThrowsException()
    {
        ...
        services.AddScoped<IUnitOfWork>(_ => _mockUow.Object);
        // IOutbox is deliberately not registered
