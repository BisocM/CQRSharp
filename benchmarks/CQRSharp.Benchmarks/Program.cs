...
using CQRSharp.Benchmarks.CqrSharp;
using CQRSharp.Benchmarks.MediatorLib;
using CQRSharp.Benchmarks.MediatRLib;
...
public class DispatchBenchmarks
{
    ...
    public Task<int> Request_MediatR() => _mediatR.Send(new CQRSharp.Benchmarks.MediatRLib.Ping());

    [BenchmarkCategory("Request"), Benchmark(Description = "Mediator 3.0 (source-gen)")]
    public ValueTask<int> Request_Mediator() => _mediator.Send(new CQRSharp.Benchmarks.MediatorLib.Ping());

    [BenchmarkCategory("Request"), Benchmark(Description = "CQRSharp")]
    public Task<int> Request_CqrSharp() => _cqrSharp.Send(new CQRSharp.Benchmarks.CqrSharp.Ping());

    [BenchmarkCategory("Request + 1 behavior"), Benchmark(Baseline = true, Description = "MediatR 12.5")]
    public Task<int> Behavior_MediatR() => _mediatRWithBehavior.Send(new CQRSharp.Benchmarks.MediatRLib.Ping());

    [BenchmarkCategory("Request + 1 behavior"), Benchmark(Description = "Mediator 3.0 (source-gen)")]
    public ValueTask<int> Behavior_Mediator() => _mediatorWithBehavior.Send(new CQRSharp.Benchmarks.MediatorLib.Ping());

    [BenchmarkCategory("Request + 1 behavior"), Benchmark(Description = "CQRSharp")]
    public Task<int> Behavior_CqrSharp() => _cqrSharpWithBehavior.Send(new CQRSharp.Benchmarks.CqrSharp.Ping());

    [BenchmarkCategory("Notification"), Benchmark(Baseline = true, Description = "MediatR 12.5")]
    public Task Notification_MediatR() => _mediatR.Publish(new CQRSharp.Benchmarks.MediatRLib.Pinged());

    [BenchmarkCategory("Notification"), Benchmark(Description = "Mediator 3.0 (source-gen)")]
    public ValueTask Notification_Mediator() => _mediator.Publish(new CQRSharp.Benchmarks.MediatorLib.Pinged());

    [BenchmarkCategory("Notification"), Benchmark(Description = "CQRSharp")]
    public Task Notification_CqrSharp() => _cqrSharp.Publish(new CQRSharp.Benchmarks.CqrSharp.Pinged());
    ...
    public async Task<int> Scoped_MediatR()
    {
        ...
        return await scope.ServiceProvider.GetRequiredService<MediatR.IMediator>().Send(new CQRSharp.Benchmarks.MediatRLib.Ping());
    }
    ...
    public async Task<int> Scoped_Mediator()
    {
        ...
        return await scope.ServiceProvider.GetRequiredService<Mediator.IMediator>().Send(new CQRSharp.Benchmarks.MediatorLib.Ping());
    }
    ...
    public async Task<int> Scoped_CqrSharp()
    {
        ...
        return await scope.ServiceProvider.GetRequiredService<ICqrsDispatcher>().Send(new CQRSharp.Benchmarks.CqrSharp.Ping());
    }
}
